"""
Django settings for mafqood_project project.
...
SECRET_KEY = 'django-insecure-a9ux1ic^(66pumvc5g$z6kpg02c$hokt%uss*io9wxit-db%jv'
...
ROOT_URLCONF = 'mafqood_project.urls'
...
WSGI_APPLICATION = 'mafqood_project.wsgi.application'
...
MEDIA_URL = '/media/'
MEDIA_ROOT = BASE_DIR.parent / 'temp_uploads'
